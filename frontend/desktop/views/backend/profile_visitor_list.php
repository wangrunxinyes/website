...
<div style="" class="table-container">
	<input type="hidden" value="<?php echo md5("profile_visitor_list"); ?>
	" id="wrx-table-type">
			...
			<table role="grid" aria-describedby="datatable_products_info" class="table table-striped table-bordered table-hover dataTable no-footer" id="datatable_products">
				<thead>
					<tr role="row" class="heading">
						...
						<th aria-label="
										 create_date
									: activate to sort column ascending" colspan="1" rowspan="1" aria-controls="datatable_products" tabindex="0" class="sorting" width="15%">访问日期</th>
						<th aria-label="
										 Actions
			...
			<div class="col-md-8 col-sm-12">
				<div id="datatable_products_paginate" class="dataTables_paginate paging_bootstrap_extended">
					<div class="pagination-panel">
						页数
						<a href="#" class="btn btn-sm default wrx-prev-page prev disabled" title="Prev"> <i class="fa fa-angle-left"></i>
						</a>
	...
	echoPage();?>">
						<a href="#" class="btn btn-sm default next wrx-next-page" title="Next"> <i class="fa fa-angle-right"></i>
						</a>
						共
