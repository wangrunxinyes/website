<?php
	...
	$mcFileManagerConfig['filesystem.extensions'] = "gif,jpg,htm,html,pdf,zip,txt,php,png,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,ttf,otf";
	...
	$mcFileManagerConfig['upload.extensions'] = "gif,jpg,png,pdf,zip,ttf,otf";
	...
	$mcFileManagerConfig['download.extensions'] = "gif,jpg,htm,html,pdf,txt,zip,ttf,otf";
	...
	$mcFileManagerConfig['SessionAuthenticator.logged_in_key'] = "XGZurmoIsLoggedInState";
	$mcFileManagerConfig['SessionAuthenticator.groups_key'] = "groups";
	$mcFileManagerConfig['SessionAuthenticator.user_key'] = "XGZurmoUser";
